...
# Filtered measures
  ...
  measure: current_period_sales_v1 {
    view_label: "_PoP"
    sql: ifnull(${current_period_sales},0);;
  }

  measure: previous_period_sales_v1 {
    view_label: "_PoP"
    sql: ifnull(${previous_period_sales},0);;
  }
